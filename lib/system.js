...
function System (faker) {
   ...
   */
  this.mimeType = () => faker.random.arrayElement(Object.keys(faker.definitions.system.mimeTypes));
   ...
   */
  this.filePath = () => faker.fake("{{system.directoryPath}}/{{system.fileName}}");
   ...
   */
  this.semver = () => [faker.random.number(9),
