...
var Unsplash = function (faker) {
   ...
   */
  self.food = (width, height, keyword) => faker.image.unsplash.imageUrl(width, height, 'food', keyword);
  /**
   * people
   *
   * @param {number} width
   ...
   */
  self.people = (width, height, keyword) => faker.image.unsplash.imageUrl(width, height, 'people', keyword);
  /**
   * nature
   *
   * @param {number} width
   ...
   */
  self.nature = (width, height, keyword) => faker.image.unsplash.imageUrl(width, height, 'nature', keyword);
  /**
   * technology
   *
   * @param {number} width
   ...
   */
  self.technology = (width, height, keyword) => faker.image.unsplash.imageUrl(width, height, 'technology', keyword);
  /**
   * objects
   *
   * @param {number} width
   ...
   */
  self.objects = (width, height, keyword) => faker.image.unsplash.imageUrl(width, height, 'objects', keyword);
  /**
   * buildings
   *
   * @param {number} width
   ...
   */
  self.buildings = (width, height, keyword) => faker.image.unsplash.imageUrl(width, height, 'buildings', keyword);
}
