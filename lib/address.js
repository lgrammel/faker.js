...
function Address (faker) {
   ...
   */
  this.cityPrefix = () => faker.random.arrayElement(faker.definitions.address.city_prefix)
   ...
   */
  this.citySuffix = () => faker.random.arrayElement(faker.definitions.address.city_suffix)
   ...
   */
  this.streetSuffix = () => faker.random.arrayElement(faker.definitions.address.street_suffix)
   ...
   */
  this.streetPrefix = () => faker.random.arrayElement(faker.definitions.address.street_prefix)
   ...
   */
  this.secondaryAddress = () => Helpers.replaceSymbolWithNumber(faker.random.arrayElement(
      [
          'Apt. ###',
          'Suite ###'
      ]
   ...
   */
  this.county = () => faker.random.arrayElement(faker.definitions.address.county)
   ...
   */
  this.country = () => faker.random.arrayElement(faker.definitions.address.country)
   ...
   */
  this.countryCode = () => faker.random.arrayElement(faker.definitions.address.country_code)
   ...
   */
  this.state = useAbbr => faker.random.arrayElement(faker.definitions.address.state)
   ...
   */
  this.stateAbbr = () => faker.random.arrayElement(faker.definitions.address.state_abbr)
