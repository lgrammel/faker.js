...
var Internet = function (faker) {
   ...
   */
  self.avatar = () => faker.random.arrayElement(faker.definitions.internet.avatar_uri);
   ...
   */
  self.url = () => faker.internet.protocol() + '://' + faker.internet.domainName();
   ...
   */
  self.domainName = () => faker.internet.domainWord() + "." + faker.internet.domainSuffix();
   ...
   */
  self.domainSuffix = () => faker.random.arrayElement(faker.definitions.internet.domain_suffix);
   ...
   */
  self.domainWord = () => faker.name.firstName().replace(/([\\~#&*{}/:<>?|\"'])/ig, '').toLowerCase();
   ...
   */
  self.ip = function () {
      var randNum = () => (faker.random.number(255)).toFixed(0);
   ...
   */
  self.userAgent = () => random_ua.generate();
