...
function Name (faker) {
   ...
   * @memberof faker.name
   */
  this.jobTitle = () => faker.name.jobDescriptor() + " " +
    faker.name.jobArea() + " " +
    faker.name.jobType();
   ...
   * @memberof faker.name
   */
  this.gender = () => faker.random.arrayElement(faker.definitions.name.gender)
   ...
   * @memberof faker.name
   */
  this.suffix = () => faker.random.arrayElement(faker.definitions.name.suffix);
   ...
   * @memberof faker.name
   */
  this.jobDescriptor = () => faker.random.arrayElement(faker.definitions.name.title.descriptor);
   ...
   * @memberof faker.name
   */
  this.jobArea = () => faker.random.arrayElement(faker.definitions.name.title.level);
   ...
   * @memberof faker.name
   */
  this.jobType = () => faker.random.arrayElement(faker.definitions.name.title.job);
