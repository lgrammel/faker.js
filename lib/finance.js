...
var Finance = function (faker) {
   ...
   */
  self.accountName = () => [Helpers.randomize(faker.definitions.finance.account_type), 'Account'].join(' ');
   ...
   */
  self.transactionType = () => Helpers.randomize(faker.definitions.finance.transaction_type);
   ...
   */
  self.currencyCode = () => faker.random.objectElement(faker.definitions.finance.currency)['code'];
   ...
   */
  self.currencyName = () => faker.random.objectElement(faker.definitions.finance.currency, 'key');
