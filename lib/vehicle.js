...
var Vehicle = function (faker) {
   ...
   */
  self.manufacturer = () => faker.random.arrayElement(faker.definitions.vehicle.manufacturer);
   ...
   */
  self.model = () => faker.random.arrayElement(faker.definitions.vehicle.model);
   ...
   */
  self.type = () => faker.random.arrayElement(faker.definitions.vehicle.type);
   ...
   */
  self.fuel = () => faker.random.arrayElement(faker.definitions.vehicle.fuel);
